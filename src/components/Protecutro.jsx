            ...
            <div className="col-lg-6 ">
              <div className="d-flex flex-column justify-content-center h-100">
                ...
                <div className="row justify-content-between">
                  <div className="col-xl-5 col-sm-6 mt-xxl-5 Animate_hover_Parent p-xxl-3 p-2 mt-3">
                    <img
                      className="mb-md-3 mb-2 Img_W_h_custom"
                      src={Proticutro1}
                      alt="Err"
                    />
                    ...
                    <p className="ff_gilroy_medium fs_sm clr_grey me-xxl-2 pt-2 mb-0">
