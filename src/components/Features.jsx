...
function Features() {
  return (
    <>
      <section className="py-5 position-relative mb-xl-5 " id="Features">
        ...
        <div className="container z_index2 position-relative mb-xx-5 mb-lg-4 mt-xxl-5">
          ...
          <h2 className="ff_gilroy_bold fw-bold fs_6x5l mb-0 clr_light_grey mt-3 mb-md-5 mb-3 pb-xl-2">
              ...
              return (
                <div className="col-xl-3 col-lg-4 col-sm-6 mt-4 Animate_hover_Parent_Second">
                  <div className="bg_light_black px-xxl-5 px-4 py-xxl-5 py-4 features_box_shadow transition300 h-100">
                    <img
                      className="Img_W_custom_Feature"
                      src={data.dataImg}
                      alt="protuct_img"
                    />
                    <h4 className="ff_gilroy_semibold fs_2x4l fw-semibold mb-0 clr_slate_grey mt-md-4 mt-2 pt-xl-2">
                      {data.heading}
                    </h4>
